/* 경로 프로젝트/src/main/java/com.example.demo/auth */
...
public class PrincipalDetailsService implements UserDetailsService{
	...
	@Autowired
	private UserMapper userMapper; //리포지토리(DAO, Mapper)에 userid 있는지 확인해야 하니깐 의존성 추가
	...
	public UserDetails loadUserByUsername(String userid) throws UsernameNotFoundException {
	    ...
	    UserDTO userId = userMapper.searchUserId(userid);	    //userId가 null 이 아니면 리턴
	    if(userId != null) {
	        return new PrincipalDetails(userId);
	    }
	    return null;
	}
